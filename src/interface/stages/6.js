...
export const stageSix = (from, message) => {
  if (message === "1") {
    let msg = "🚨 Produtos  🚨\n\n";

    Object.keys(tapetes).map((value) => {
      const element = tapetes[value];
      if (value === "1") {
        msg += `1: - _${element.nome}_ \n`;
      } else if (value === "2") {
        msg += `2: - _${element.nome}_ \n`;
      } else if (value === "3") {
        msg += `3: - _${element.nome}_ \n`;
      } else if (value === "4") {
        msg += `4: - _${element.nome}_ \n`;
      } else if (value === "5") {
        msg += `5: - _${element.nome}_ \n`;
      } else if (value === "6") {
        msg += `6: - _${element.nome}_ \n`;
      }
    });
